...
class BOV:
    ...
    def trainModel(self):
        ...
        self.images, self.trainImageCount = self.file_helper.getFiles(self.path,self.train_path)
    ...
    def testModel(self):
        ...
        self.testImages, self.testImageCount = self.file_helper.getFiles(self.path,self.test_path)
        ...
        for each in predictions:
            ...
            plt.title('Predict Value: ' + each['object_name'])
            plt.show()
